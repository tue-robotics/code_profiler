                          ...
                          double totalTime)
{
    ...
    for (vector<map<string, Statistics>*>::iterator it = stats.begin(); it != stats.end(); ++it)
    {
        ...
        stream << setw(15) << "Name:" << setw(20) << "Total Time:" << setw(30) << "Average time" << setw(30)
               << "Relative Time:" << setw(15) << "Called #:" << endl;
        ...
        for (map<string, Statistics>::iterator it2 = (*it)->begin(); it2 != (*it)->end(); ++it2)
        {
            ...
            if (!stats.running)
                stream << setw(15) << it2->first << setw(20) << stats.msec << setw(30)
                       << (stats.msec / stats.callAmount) << setw(30) << stats.msec / totalTime << setw(30)
                       << stats.callAmount << endl;
            else
